...
class TestCase
{
    ...
    static function testGet()
    {
        ...
        return HttpClient::get($url, [], [], true);
    }
    ...
    static function testPost()
    {
        ...
        return HttpClient::post($url, $payload, [], ['Content-Type' => 'application/json'], HttpForm::FORMAT_JSON, ['only_error' => false, 'log_name_file' => 'testCaseMethodPost']);
    }
    ...
    static function testMultiCurl()
    {
        ...
        $form1 = HttpForm::init(self::BASE_URL . '/posts/1')
            ->activeLog(false, 'test1')
            ->method(HttpForm::METHOD_GET);
        $form2 = HttpForm::init(self::BASE_URL . '/users/1')
            ->activeLog(false, 'test2')
            ->method(HttpForm::METHOD_GET);
        $form3 = HttpForm::init(self::BASE_URL . '/todos/1')
            ->activeLog(false, 'test3')
            ->method(HttpForm::METHOD_GET);
